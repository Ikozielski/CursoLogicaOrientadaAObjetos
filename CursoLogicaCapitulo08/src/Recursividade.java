...
public class Recursividade {
	...
	public static void main(String[] args) {
		...
		Boolean posicaoValida = verificarPosicaoEscolhidaPeloUsuario(posicaoCursoEscolhido, cursos); // posicaoCursoEscolhido
																										// >= 0 &&
		...
		Integer posicaoFormaPagamentoEscolhida = receberNumeroInteiroDoUsuario(
				"A forma de pagamento que você deseja é o: ", scanner);

		posicaoValida = verificarPosicaoEscolhidaPeloUsuario(posicaoFormaPagamentoEscolhida, formasPagamento); // posicaoFormaPagamentoEscolhida
																												// >= 0
																												// &&
																												// posicaoFormaPagamentoEscolhida
																												// <
