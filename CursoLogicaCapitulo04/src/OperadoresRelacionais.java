...
public class OperadoresRelacionais {
	public static void main(String[] args) {
		...
		Integer centoViteOito = 128;
		Integer centoVinteOito02 = 128;
		
		Boolean centoViteOitoIgualCentoVinteOito = centoViteOito.equals(centoVinteOito02);
		System.out.println("centoViteOito.equals(centoVinteOito02)? " + centoViteOitoIgualCentoVinteOito);
		
		Boolean centoViteOitoIgualCentoVinteOito02 = centoViteOito == centoVinteOito02;
		System.out.println("centoViteOito == centoVinteOito02? " + centoViteOitoIgualCentoVinteOito02);
	}
}
